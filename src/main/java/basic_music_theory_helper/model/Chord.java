...
public enum Chord {
    ...
    DOMINANT_SEVENTH(Arrays.asList("7", "Mm7", "majm7", "maj♭7"), "도미넌트 세븐스 코드", "7th 코드", "047X", Arrays.asList("근음", "장3도", "완전5도", "단7도")),
    ...
    DOMINANT_MINOR_NINTH(Arrays.asList("7♭9"), "도미넌트 마이너 나인스 코드", "9th 코드", "047X1", Arrays.asList("근음", "장3도", "완전5도", "단7도", "단9도")),
    ...
    HALF_DIMINISHED_NINTH(Arrays.asList("ø9"), "하프 디미니쉬 나인스 코드", "9th 코드", "036X2", Arrays.asList("근음", "단3도", "감5도", "단7도", "장9도")),
    HALF_DIMINISHED_MINOR_NINTH(Arrays.asList("ø♭9"), "하프 디미니쉬 마이너 나인스 코드", "9th 코드", "036X1", Arrays.asList("근음", "단3도", "감5도", "단7도", "단9도")),
    DIMINISHED_NINTH(Arrays.asList("dim9"), "디미니쉬 나인스 코드", "9th 코드", "03692", Arrays.asList("근음", "단3도", "감5도", "감7도", "장9도")),
    DIMINISHED_MINOR_NINTH(Arrays.asList("dim♭9"), "디미니쉬 마이너 나인스 코드", "9th 코드", "03691", Arrays.asList("근음", "단3도", "감5도", "감7도", "단9도")),
    ...
    HALF_DIMINISHED_ELEVENTH(Arrays.asList("ø11"), "하프 디미니쉬 일레븐스 코드", "11th 코드", "036X25", Arrays.asList("근음", "단3도", "감5도", "단7도", "장9도", "완전11도")),
    ...
    HALF_DIMINISHED_THIRTEENTH(Arrays.asList("ø13"), "하프 디미니쉬 서틴스 코드", "13th 코드", "036X259", Arrays.asList("근음", "단3도", "감5도", "단7도", "장9도", "완전11도", "장13도")),
    ...
    MINOR_FLAT_SIXTH(Arrays.asList("m♭6"), "마이너 플랫 식스 코드", "6th 코드", "0378", Arrays.asList("근음", "단3도", "완전5도", "단6도")),
