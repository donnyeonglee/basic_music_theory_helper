...
- Y, y, Yes, yes 입력 시 타브 출력 실행
- N, n, No, no 입력 시 "프로그램을 종료합니다." 문구 출력 후 타브를 출력하지 않고 프로그램 종료
...
- 각 sliding window에서 코드 구성음이 존재하는 위치 탐색. 개방현과 근음이 존재하는 줄보다 높은 음의 줄에서 탐색. 모든 경우를 따져야 하므로 탐욕법을 이용
